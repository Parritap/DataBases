...
ALTER TABLE prestamo ADD CONSTRAINT prestamo_pk PRIMARY KEY ( prestamo_id );
...
CREATE TABLE profesor (
    ...
    especializacion_profesor VARCHAR(50)
)
LOGGING;
...
ALTER TABLE aula
    ADD CONSTRAINT aula_departamento_fk FOREIGN KEY ( departamento_id )
        REFERENCES departamento ( id_departamento )
    NOT DEFERRABLE;

ALTER TABLE biblioteca
    ADD CONSTRAINT biblioteca_libro_fk FOREIGN KEY ( libro_id )
        REFERENCES libro ( id_libro )
    NOT DEFERRABLE;

ALTER TABLE curso
    ADD CONSTRAINT curso_aula_fk FOREIGN KEY ( aula_id )
        REFERENCES aula ( id_aula )
    NOT DEFERRABLE;

ALTER TABLE curso
    ADD CONSTRAINT curso_departamento_fk FOREIGN KEY ( departamento_id )
        REFERENCES departamento ( id_departamento )
    NOT DEFERRABLE;

ALTER TABLE curso
    ADD CONSTRAINT curso_profesor_fk FOREIGN KEY ( profesor_id )
        REFERENCES profesor ( id_profesor )
    NOT DEFERRABLE;

ALTER TABLE evento
    ADD CONSTRAINT evento_aula_fk FOREIGN KEY ( aula_id )
        REFERENCES aula ( id_aula )
    NOT DEFERRABLE;

ALTER TABLE inscripcion
    ADD CONSTRAINT inscripcion_curso_fk FOREIGN KEY ( curso_id )
        REFERENCES curso ( id_curso )
    NOT DEFERRABLE;

ALTER TABLE inscripcion
    ADD CONSTRAINT inscripcion_estudiante_fk FOREIGN KEY ( estudiante_id )
...
ALTER TABLE prestamo
    ADD CONSTRAINT prestamo_estudiante_fk FOREIGN KEY ( estudiante_id )
        REFERENCES estudiante ( id_estudiante )
    NOT DEFERRABLE;
